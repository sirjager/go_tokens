...
func ValidateUsername(value string) error {
	if err := ValidateLength(value, 3, 60); err != nil {
		return err
	}
...
func ValidatePassword(value string) error {
	if err := ValidateLength(value, 6, 255); err != nil {
		return err
	}
	return nil
}
...
func ValidateEmail(value string) error {
	if err := ValidateLength(value, 3, 255); err != nil {
		return err
	}
...
func ValidateName(value string) error {
	if err := ValidateLength(value, 1, 255); err != nil {
		return err
	}
